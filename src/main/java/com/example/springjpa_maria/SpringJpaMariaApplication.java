...
public class SpringJpaMariaApplication {
	...
	@Transactional
	@Bean
	public CommandLineRunner run(ProjectService projectService, StaffService staffService) throws Exception{
		return (args -> {
			//Khởi tạo
			...
			System.out.println(staffService.getString_ListStaff());
			System.out.println("Click link: http://localhost:8080/projects");
			System.out.println("Click link: http://localhost:8080/staffs");
		});
	}
}
